...
<head>
    ...
    <title>Login Administrator | Sistem Informasi Arsip Kepegawaian</title>
...
<body>
    <div class="error-pagewrap">
        <div class="error-page-int">
            <div class="text-center m-b-md custom-login">
                <h3> KEPEGAWAIAN</h3>
                <h4>Sistem Informasi Kepegawaian PT.BAM</h4>
                <p>Silahkan login untuk mengakses kepegawaian.</p>
            ...
            <div class="content-error">
                ...
                <div class="hpanel">
                    <div class="panel-body">
                        <center>
                             <img src="gambar/depan/logobaru.png" width="100" height="auto"><br><br>
            ...
            <div class="text-center login-footer">
                <p class="text-muted">Copyright © <?php echo date('Y') ?>.Sistem Informasi Kepegawaian PT.BAM</p>
            </div>
        </div>   
    </div>
	...
	<body class="hold-transition login-page" style="background:url(gambar/depan/slider-bamedika.jpg)
