    ...
    <div class="left-sidebar-pro">
        <nav id="sidebar" class="">
            <div class="sidebar-header">
                <a href="index.html"><img class="main-logo" src="../assets/img/logo/logobaru.png" height="180" width="150"/></a>
                ...
                <nav class="sidebar-nav left-sidebar-menu-pro" style="margin-top: 30px">
                    ...
                    <ul class="metismenu" id="menu1">
                        ...
                        <ul class="submenu collapse">
                            <li>
                            <a href="petugas.php" aria-expanded="false"><span class="educate-icon educate-professor icon-wrap sub-icon-mg " aria-hidden="true"></span> <span class="mini-click-non">Data Admin</span></a>
                        </li>
                    ...
                    <li class="nav-item has-submenu">
                        <a class="nav-link" href="#"aria-expanded="false"><span class="educate-icon educate-course icon-wrap sub-icon-mg" aria-hidden="true"></span> <span class="mini-click-non"> Data Pelengkap</span>  </a>
                        <ul class="submenu collapse">
                            <li>
                            <a href="jabatan.php" aria-expanded="false"><span class="educate-icon educate-professor icon-wrap sub-icon-mg" aria-hidden="true"></span> <span class="mini-click-non">Jabatan</span></a>
                        </li>
