                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <div class="breadcome-heading">
                                <h4 style="margin-bottom: 0px">Lokasi</h4>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
    ...
    <div class="panel panel">
        ...
        <div class="panel-body">
            <div class="pull-right">
                <a href="lokasi_tambah.php" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah Lokasi</a>
            </div>
            <br>
            <br>
            <br>
            ...
            <table id="table" class="table table-bordered table-striped table-hover table-datatable">
                ...
                <tbody>
                    ...
                    include '../koneksi.php';
                    $no = 1;
                    $status = mysqli_query($koneksi,"SELECT * FROM lokasi");
