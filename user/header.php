    ...
    <div class="left-sidebar-pro">
        <nav id="sidebar" class="">
            <div class="sidebar-header">
                <a href="index.html"><img class="main-logo" src="../assets/img/logo/logobaru.png"width="100" height="auto"alt="" /></a>
                <strong><a href="index.html"><img src="../assets/img/logo/logobaru.png" alt="" /></a></strong>
            </div>
            <div class="left-custom-menu-adp-wrap comment-scrollbar">
                ...
                <nav class="sidebar-nav left-sidebar-menu-pro" style="margin-top: 30px">
                    ...
                    <ul class="metismenu" id="menu1">
                        ...
                        <li>
                            <a href="arsip.php" aria-expanded="false"><span class="educate-icon educate-professor icon-wrap sub-icon-mg" aria-hidden="true"></span> <span class="mini-click-non">Data Karyawan</span></a>
                        </li>

                        <li>
                            <a href="keuangan.php" aria-expanded="false"><span class="educate-icon educate-data-table icon-wrap sub-icon-mg" aria-hidden="true"></span> <span class="mini-click-non">Status Karyawan</span></a>
                        </li>

                        <li>
                            <a href="sertif.php" aria-expanded="false"><span class="educate-icon educate-data-table icon-wrap sub-icon-mg" aria-hidden="true"></span> <span class="mini-click-non">Sertifikat</span></a>
                        </li>
                                    ...
                                    <div class="col-lg-6 col-md-7 col-sm-6 col-xs-12">
                                        <div class="header-top-menu tabl-d-n">
                                            <ul class="nav navbar-nav mai-top-nav">
                                                <li class="nav-item"><a href="#" class="nav-link">sistem informasi kepegawaian PT.BAM</a></li>
                                        </ul>
                                    </div>
                                </div>
                                        ...
                                        <li class="nav-item">
                                            ...
                                            <li class="nav-item">
                                                <a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle">
                                                    ...
                                                    <?php 
                                                    $id_user = $_SESSION['id'];
                                                    $profil = mysqli_query($koneksi,"select * from diri where id='$id_user'");
                                                    ...
                                                    if($profil['foto'] == ""){ 
                                                        ...
                                                        ?>
                                                        <img src="../gambar/user/<?php echo $profil['foto'] ?>">
                                                        <?php 
                                                    } 
                                                    ?>
